...
Commnet.create(content:"first comment for first post",post_id: 1)
Commnet.create(content:"Second comment for first post",post_id: 1)
Commnet.create(content:"Third comment for first post",post_id: 1)